...
fn main() {
    ...
    let poligono4 = [(413, 177), (448, 159), (502, 88), (553, 53), (535, 36), (676, 37), (660, 52), (750, 145), (761, 179), (672, 192), (659, 214), (615, 214), (632, 230), (580, 230), (597, 215), (552, 214), (517, 144), (466, 180)];
    let poligono5 = [(682, 175), (708, 120), (735, 148), (739, 170)];
    framebuffer.set_current_color(0xFFFF00);
    ...
    framebuffer.set_current_color(0x0000FF);
    framebuffer.scan(&[&poligono4, &poligono5]);
